...
const yargs = require("yargs/yargs"); // yargs is used to parse command line arguments in Node.js
const { hideBin } = require("yargs/helpers"); // hideBin is used to remove the first two arguments (node and server.js) from the array
...
var dataPort = argv.port || 71
; // this is the port to listen on for data from
